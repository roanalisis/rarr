...
<html>
    ...
    <body>
        ...
        <% 
            ...
            s.setAttribute("nombreIndex", "indexConfigurador");
        %>
            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class = "active"><a><p style="color:#33FF63";><i class="fa fa-cogs"></i> <span class="nav-label">Configuración</span></p></a> </li>
                        ...
                        <li><a href="configuracion.htm"><i class="fa fa-cog"></i> <span class="nav-label">Configurar Termómetro</span></a></li>
        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" action="search_results.html">
                <div class="form-group">
                    <input type="text" placeholder="Buscar... (desabilitado)    " class="form-control" name="top-search" id="top-search">
                </div>
            </form>
        </div>
...
<!--                <li>
                ...
                <div class="row  border-bottom white-bg dashboard-header">
                    ...
                    <div class="col-sm-3">
                        <h2>Bienvenido a A.T.A.</h2>
                        <small>Dashboard desabilitado temporalmente.</small>
       ...
       <div class="row">
            <div class="col-lg-12">
                ...
                <div class="footer">
                    ...
                    <div>
                        <strong>Copyright</strong> MMR/UGM &copy; 2018
                    </div>
                </div> 
            </div>
        </div>
