...
<!--                    <li class="nav-header">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li class="active"><a href="histograma.htm">Histograma</a></li>
...
<!--                                            <h1 class="m-b-xs">$ 50,992</h1>-->
                                            <h3 class="Histograma: Termómetro #1">
                                                Histograma: Termómetro #1                       
                                            </h3>
...
<!--                                        <small class="pull-right">
                                       ...
                                       <small>
                                           <strong>Selecciona termómetro:</strong>

                                           <button data-toggle="dropdown" class="btn btn-white dropdown-toggle" type="button">Termómetro 1 <span class="caret"></span></button>
                                                <ul class="dropdown-menu">
                                                    <li><a href="#">Termómetro 1</a></li>
                                                    <li><a href="#">Termómetro 2</a></li>
                                                    <li><a href="#">Termómetro 3</a></li>
                                                    <li><a href="#">Termómetro 4</a></li>
                                                </ul>
